...
def make_model(args, parent=False):
    return Plain_ECB_EDSR(args)

class Plain_ECB_EDSR(nn.Module):
    def __init__(self, args, conv=common.default_conv, with_idt=False, bias_type=True, group_num=1):
        super(Plain_ECB_EDSR, self).__init__()
        ...
        # m_head = [conv(args.n_colors, n_feats, kernel_size, groups=group_num)]
        ...
        # define body module
        m_body = [
            common.PlainECBResBlock(
                conv, n_feats, kernel_size, act=act, res_scale=args.res_scale, groups=group_num
        ...
        # m_body.append(conv(n_feats, n_feats, kernel_size, groups=group_num))
